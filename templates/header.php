...
<html lang="en">
  ...
  <body>
    <div class="row" style="padding:10px;margin:0;border-bottom:1px solid #ccc">
        <div class="col-12 col-sm-4 "><center><img src="img/logo.png" style="width:70px;"><span style="font-size:25px;margin-left:15px;color:#565b98;position:relative;top:8px;"><span style="color:#ce0000;">ГОС</span>ЗАКУПКИ</span></center></div>
        <div class="col-12 col-sm-6">
                        
        <div class="nav_header" style="text-align:right;">
        ...
        <div class="col-2 d-none d-sm-block">
            <div class="nav_header_contacts">
                <div>+7 (777) 78 78 78</div>
                <div>+7 (888) 78 78 78</div>
            </div>
        </div>
    </div>